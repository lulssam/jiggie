...
create table cao (
  ...
  raca text,
  nascimento date,
  cor smallint not null default 0 constraint cao_cor_valida check (cor between 0 and 4),
...
create table comida (
  ...
  base text not null check (base in ('seca', 'humida', 'mista')),
...
-- =============================================================================
revoke
execute on function create_familia (text)
from
  public;

revoke
execute on function join_familia (text)
from
  public;

revoke
execute on function leave_familia ()
from
  public;

revoke
execute on function get_codigo_convite ()
from
  public;

revoke
execute on function current_familia_id ()
from
  public;

revoke
execute on function limpar_familias_orfas (int)
from
  public;

grant
execute on function create_familia (text) to authenticated;

grant
execute on function join_familia (text) to authenticated;

grant
execute on function leave_familia () to authenticated;

grant
execute on function get_codigo_convite () to authenticated;
...
grant
execute on function current_familia_id () to authenticated;
...
grant
update (nome) on familia to authenticated;
...
grant
update (nome) on dono to authenticated;
...
grant
update (dh_passeio, xixi, coco, cao_id) on passeio to authenticated;
...
grant
update (dh_comida, quantidade, extras, cao_id) on comida to authenticated;
...
grant
update (dh_agua, quantidade, cao_id) on agua to authenticated;
...
grant
update (dh_sintoma, tipo, descricao, cao_id) on sintoma to authenticated;

revoke
update on administracao_medicamento
from
  authenticated;
...
create policy "select_familia" on familia for
select
  using (
    id = (
      select
...
create policy "update_familia" on familia
for update
  using (
    id = (
      select
...
-- dono ------------------------------------------------------------------------
create policy "select_dono" on dono for
select
  using (
    id = (
      select
...
create policy "update_dono" on dono
for update
  using (
    id = (
      select
...
-- cao -------------------------------------------------------------------------
create policy "select_cao" on cao for
select
  using (
    familia_id = (
      select
...
create policy "update_cao" on cao
for update
  using (
    familia_id = (
      select
...
create policy "delete_cao" on cao for delete using (
  familia_id = (
    select
      current_familia_id ()
  )
...
create policy "select_medicamento" on medicamento for
select
  using (
    cao_id in (
      select
...
create policy "update_medicamento" on medicamento
for update
  using (
    cao_id in (
      select
...
-- passeio
create policy "select_passeio" on passeio for
select
  using (
    familia_id = (
      select
...
create policy "update_passeio" on passeio
for update
  using (
    familia_id = (
      select
...
create policy "delete_passeio" on passeio for delete using (
  familia_id = (
    select
      current_familia_id ()
  )
...
-- comida
create policy "select_comida" on comida for
select
  using (
    familia_id = (
      select
...
create policy "update_comida" on comida
for update
  using (
    familia_id = (
      select
...
create policy "delete_comida" on comida for delete using (
  familia_id = (
    select
      current_familia_id ()
  )
...
-- agua
create policy "select_agua" on agua for
select
  using (
    familia_id = (
      select
...
create policy "update_agua" on agua
for update
  using (
    familia_id = (
      select
...
create policy "delete_agua" on agua for delete using (
  familia_id = (
    select
      current_familia_id ()
  )
...
-- sintoma
create policy "select_sintoma" on sintoma for
select
  using (
    familia_id = (
      select
...
create policy "update_sintoma" on sintoma
for update
  using (
    familia_id = (
      select
...
create policy "delete_sintoma" on sintoma for delete using (
  familia_id = (
    select
      current_familia_id ()
  )
...
create policy "select_administracao" on administracao_medicamento for
select
  using (
    familia_id = (
      select
...
create policy "update_administracao" on administracao_medicamento
for update
  using (
    familia_id = (
      select
...
create policy "delete_administracao" on administracao_medicamento for delete using (
  familia_id = (
    select
      current_familia_id ()
  )
