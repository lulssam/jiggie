...
/**
 * Liga o [AguaViewModel] ao [AguaScreenContent].
 *
...
@Composable
fun AguaScreen(
    viewModel: AguaViewModel = viewModel { AguaViewModel() },
    caoId: String,
    onGravado: () -> Unit
) {
